...
PROJECT_ID = 118921164278772704
INTERNAL_RETRIES = 5
DEFAULT_CHUNK_SIZE = 1_000_000

# Static credentials (override with env vars if desired)
FLOWBIO_USERNAME = os.environ.get("FLOWBIO_USERNAME", "username")
FLOWBIO_PASSWORD = os.environ.get("FLOWBIO_PASSWORD", "password")
